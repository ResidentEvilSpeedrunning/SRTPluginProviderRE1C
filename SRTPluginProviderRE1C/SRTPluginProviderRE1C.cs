...
{
    public class SRTPluginProviderRE1C : IPluginProvider
    {
        private Process process;
        private GameMemoryRE1CScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryRE1CScanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("Biohazard")?.FirstOrDefault();
    }
}
